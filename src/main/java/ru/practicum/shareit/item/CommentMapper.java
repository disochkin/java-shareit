...
import ru.practicum.shareit.item.dto.CommentAddRequest;
...
public class CommentMapper {
    public static Comment addCommentRequestToComment(User author, Item item, CommentAddRequest commentAddRequest) {
