...
public class ItemRequestService {
    ...
    public ItemRequestCreateDto create(Long requestorId, ItemRequestAddDto itemRequestAddDto) {
        ...
        ItemRequest createdItemRequest = itemRequestRepository.save(RequestMapper.itemRequestAddDtoToItemRequest(requestor, itemRequestAddDto));
        return RequestMapper.itemRequestToRequestCreateDto(createdItemRequest);
    }
    ...
    public List<ItemRequestWithAnswer> getOwnRequests(Long requestorId) {
        ...
        return itemRequestRepository.findByRequesterIdOrderByCreatedDesc(requestorId).stream()
                .map(RequestMapper::itemRequestToItemRequestWithAnswerDto).toList();
    }
    ...
    public ItemRequestWithAnswer getRequestById(Long requestId) {
        ...
        return RequestMapper.itemRequestToItemRequestWithAnswerDto(itemRequest);
    }}
